...
// ============================================================================
// ROLE/ORGANIZATION RELATIONAL VIEWS
// ============================================================================

export interface UserRolePermissionLink {
  permission: {
    id: string;
    code: string;
    name: string;
...
export interface UserRoleLink {
  ...
  roleCode: string;
  roleName: string;
  permissions: UserRolePermissionLink[];
}

export interface UserRoleAssignmentLink {
  id: string;
  role: UserRoleLink;
  hotel: {
    id: string;
...
export interface UserWithRoles extends User {
  userRoles: UserRoleAssignmentLink[];
}
