...
v1Router.use("/organizations/:organizationId/hotels", hotelsRoutes);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/rooms",
  roomsRoutes,
);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/rate-plans",
  ratePlansRoutes,
);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/room-types",
  roomTypesRoutes,
);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/reservations",
  reservationsRoutes,
);
v1Router.use(
...
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId",
...
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/inventory",
  inventoryRoutes,
);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/housekeeping",
  housekeepingRoutes,
);
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/maintenance",
  maintenanceRoutes,
);
...
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/guests",
  guestsInHouseRouter,
);
v1Router.use(
...
v1Router.use(
  "/organizations/:organizationId/hotels/:hotelId/channels",
  channelRoutes,
);
